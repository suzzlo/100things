...
Thing.create([
  { :name => "RunKeeper Android App", :user_id => "1", :category_id => "1", :price => 9.95, :adquired => '2010-12-01 00:00:00' },
  { :name => "Swift Android keyboard", :user_id => "1", :category_id => "1", :price => 3.0, :adquired => '2010-12-01 00:00:00' },
  { :name => "iMac 24'", :user_id => "1", :category_id => "2", :price => 1400.0, :adquired => '2010-12-01 00:00:00' },
  { :name => "MacBookPro 13.3'", :user_id => "1", :category_id => "2", :price => 1100.0, :adquired => '2010-12-01 00:00:00' },
  { :name => "HTC Magic", :user_id => "1", :category_id => "2", :price => 250.0, :adquired => '2009-08-24 00:00:00' },
  { :name => "Reloj Swatch", :user_id => "1", :category_id => "3", :price => 38.0, :adquired => '2010-12-01 00:00:00'},
  { :name => "Chaqueta bench marron", :user_id => "1", :category_id => "1", :price => 0.0, :adquired => '2010-09-20 00:00:00'},
  ...
  { :name => "Cascos bluetooth", :user_id => "1", :category_id => "1", :price => 18.0, :adquired => '2010-09-30 00:00:00'},
  { :name => "Zapatillas Diesel negras", :user_id => "1", :category_id => "1", :price => 90.0, :adquired => '2010-08-24 00:00:00'},
  { :name => "Zapatillas Diesel grises", :user_id => "1", :category_id => "1", :price => 75.0, :adquired => ''},
  ...
  { :name => "Gafas", :user_id => "1", :category_id => "1", :price => 145.0, :adquired => '2010-08-24 00:00:00'},
  { :name => "RunKeeper Android App", :user_id => "1", :category_id => "1", :price => 9.9, :adquired => '2010-09-01 00:00:00'},
  ...
  { :name => "Reloj Swatch", :user_id => "1", :category_id => "1", :price => 38.0, :adquired => '2010-12-01 00:00:00'},
  ...
  { :name => "Omega Seamaster", :user_id => "1", :category_id => "1", :price => 0.0, :adquired => '2008-12-25 00:00:00'},
